// //18 การเพิ่ม Resolution ให้กับจอยสติ๊กโมดูลสำหรับหุ่นยนต์
...
//   }
//   // เลี้ยวซ้าย
//   if (joy_pos_X < L_POINT && joy_button == 1){ // หลบค่าที่อยู่ในช่วงของย่านต้องห้ามของจอยสติ้ก
//      // กลับค่าจาก 460 -> 0 เป็น 0 -> 460 แทน
...
//     }
//   }
//   else if (joy_pos_X > H_POINT && joy_button == 1){ // หลบค่าที่อยู่ในช่วงของย่านต้องห้ามของจอยสติ้ก
//    //เลี้ยวขวา
...
//     }
//   }
//   else if (joy_pos_X < L_POINT && joy_button == 0){ //กรณีที่มีการกดปุ่มแล้วเลี้ยวซ้าย
...
//     }
//   }
//   else if (joy_pos_X > H_POINT && joy_button == 0){ //กรณีที่มีการกดปุ่มแล้วเลี้ยวขวา

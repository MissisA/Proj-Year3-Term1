...
// //10 Episode 2 เคสตัวอย่างเครื่องจักรสำหรับคัดแยกสินค้าโดยไม่ได้ใช้วิธีการ Interrupts !!! 14:00
...
//   attachInterrupt(digitalPinToInterrupt(BUTTON_PIN),Lemon,LOW); //pull-up , LOW = '0' เมื่อกดสวิตซ์โดดไฟทำงานฟังก์ชัน Lemon

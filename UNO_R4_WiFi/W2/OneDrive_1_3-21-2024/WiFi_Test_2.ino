...
void loop() {
  ...
  if (client) {
    ...
    client.println("<script type='text/javascript'>  "); //ตั้งค่ารีเฟรซอัติโนมัติ ทุก ๆ 1 วินาที
    client.println("setTimeout(function(){ window.location.reload(1); }, 1000); "); //ตั้งค่ารีเฟรซอัติโนมัติ ทุก ๆ 1 วินาที
    client.println(" </script>"); //ตั้งค่ารีเฟรซอัติโนมัติ ทุก ๆ 1 วินาที
